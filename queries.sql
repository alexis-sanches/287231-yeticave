...
VALUES
  ...
  ('2017-07-29 12:20:00', 'Крепления Union Contact Pro 2015 года размер L/XL', 'description', 'img/lot-3.jpg', 8000, '2017-10-05 00:00:00', 250, 14, 3, 1, 2),
  ('2017-09-14 13:30:00', 'Ботинки для сноуборда DC Mutiny Charocal', 'description', 'img/lot-4.jpg', 10999, '2017-10-22 00:00:00', 450, 10, 1, 3, 3),
...
VALUES
  ('2017-09-11 20:19:44', 11999, 3, 1),
  ('2017-08-29 11:22:33', 11499, 2, 1);

/* Получить список из всех категорий */
SELECT * FROM categories;

/* Получить самые новые, открытые лоты */
SELECT l.id, l.title, price, image_url, c.title
FROM lots l
  JOIN categories c
...
SELECT * FROM lots WHERE title LIKE 'Rossignol';
SELECT * FROM lots WHERE description LIKE 'Rossignol';
