...
<form class="form container<?=count($errors) ? ' form--invalid' : '' ?>" action="signup.php" method="post" enctype="multipart/form-data" novalidate> <!-- form--invalid -->
    ...
    <div class="form__item">
        ...
        <input id="name" type="text" name="name" placeholder="Введите имя" value="<?=strip_tags(isset($_POST['name']) ? $_POST['name'] : ''); ?>" required>
    ...
    <div class="form__item">
        ...
        <textarea id="message" name="message" placeholder="Напишите как с вами связаться" required><?=strip_tags(isset($_POST['message']) ? $_POST['message'] : ''); ?></textarea>
